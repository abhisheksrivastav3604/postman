...
class Home extends Component {
    ...
    async link(url, obj) {
        ...
        if (data.status >= "400") {
            ...
            let s1 = { ...this.state }
            s1.form.response = data[0];
            s1.headersdata=data[1]
            s1.status = status
    ...
    render() {
        ...
        let { urldata, hide, index, status, statusText, time, history, histories, header,header1,loading,headersdata } = this.state;
