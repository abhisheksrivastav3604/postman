...
class Home extends Component {
    ...
    render() {
        ...
        let { urldata, hide, index, status, statusText, time, history, histories, header,header1,loading } = this.state;
                ...
                <div className="row">
                    ...
                    <div className={history == 0 ? "col-11 border " : "col-9 border "}>
                        ...
                        <div className="">
                            ...
                            {response == "" || response.code == "ERR_INVALID_URL" || response.code == "ENOTFOUND" ? <div className="col-1 ms-3" style={loading==false ? {"filter":"blur(1px)"}:{}}>Response</div> :
                            ...
                            <div className="mt-2">
                                <div class="form" style={loading==false ? {"filter":"blur(1px)"}:{}}>
                                    <textarea class="form-control"
